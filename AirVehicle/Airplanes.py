...
# Класс наследник Самолёты
class Airplanes(AirVehicle, IAirVehicle, IPassengerTransportation):
    """Инициализирует самолет с дополнительными параметрами веса, топлива и числа пассажиров"""
    def __init__(self, name, size, purpose, weight, fuel, passengers):
        ...
        self._weight = weight                       # Вес самолета
    ...
    def info(self):
        """Представление подробной информации о самолете"""
