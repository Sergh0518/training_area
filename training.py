...
def handle_case_1():
    ...
    try:
        ...
        # TODO: Технически, задание выполнено верно, но:
        #  Встроенные функции это конечно хорошо, но давай лучше через циклы и алгоритмы сортировки)
...
def handle_case_3():
    ...
    # TODO: Либо я что-то не понимаю, но оно у меня не работает. Вот ввод\вывод:
    #  Введите в строку числа через запятую: 1, 5, 3аб, 88, биба, 28.4
    #  1, 5, 3аб, 88, биба, 28.4
    #  Попробуй подумать в сторону приведения типов и try\except, а не регулярок
    # Получаем значение с терминала
...
def handle_case_5():
    ...
    # TODO: Смотри, ты тут забыл определить сам делимер.
    #  Можешь его указать сам, либо предложить ввести -- разницы нет.
    #  То как сейчас, ты просто посимвольно перебираешь строку и получается, если я ввиду "33", то уже покажет, что нет уникальных чисел)
